...
//    mutating func changeNote(_ shiftNote: Note) {
//        // editing an existing note into the array of notes
////        if let index = notes.index(where: {$0.id == shiftNote.id}) {
////            notes[index].name = shiftNote.name
////        }
//        print("The edited note id is: \(shiftNote.id)")
//        print("The edited note name is: \(shiftNote.name)")
//        print("You are in edit note mode")
//
//        changeElementAtIndex(element: shiftNote, index: shiftNote.id)
//
