...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let testBook1 = Book(id: 0, name: "Test")
        let testBook2 = Book(id: 1, name: "Hello")
        
        arrayToBeShown += [testBook1, testBook2]
    }
...
//        let book = manageBooks.books[indexPath.row]
        let book = arrayToBeShown[indexPath.row]
