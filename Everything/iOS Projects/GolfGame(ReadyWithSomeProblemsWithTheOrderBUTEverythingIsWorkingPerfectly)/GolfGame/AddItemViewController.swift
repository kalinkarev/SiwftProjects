...
//    var arrayDictKeys: [Int] = []
    ...
    override func viewDidLoad() {
        ...
        if let game = game {
            ...
            arrayWithHoles = Array(dictionaryHolePointsOfSelectedGame.keys)
            print("The array of keys in the selected game is: \(arrayWithHoles)")
            
            arrayDictValues = Array(dictionaryHolePointsOfSelectedGame.values)
            print("The array of values in the selected game is: \(arrayDictValues)")
...
//            let arrayWithHoles = game.dictionaryHolePoints.keys.enumerated().sorted(by: >)
//            print("The array of dictionaries is: \(arrayWithHoles)")
