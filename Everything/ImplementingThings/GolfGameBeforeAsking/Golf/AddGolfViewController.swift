...
class AddGolfViewController: UIViewController {
    ...
    func showActionSheet() {
        let alertController = UIAlertController(title: "Shoose how many holes to have the golf game", message: nil, preferredStyle: .actionSheet)
        ...
        let cancelButton = UIAlertAction(title: "Cancel button", style: .cancel, handler: {
            (action) -> Void in
